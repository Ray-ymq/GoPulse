...
> 总方案来源：[Phase-00-总实施方案.md](../../dev-phases/Phase-00-总实施方案.md)
...
- RabbitMQ：每次检查创建短生命周期 AMQP 连接，成功后立即关闭。
...
- 初始化过程中任一步失败，应关闭此前已经成功创建的资源。
- 接收到终止信号后，停止接收新请求并在限定时间内关闭 HTTP Server。
