...
> 失败诊断，但没有证明容量基线通过，不得再次按本文运行三轮。后续以总实施方案的 Phase-18-02
> 修复 Outbox，并由 Phase-18-06 做最终容量验收。
...
不在本批追加重跑；2026-09-26 重划后由 Phase-18-02 的短窗口验证修复，并由
Phase-18-06 作最终容量验收。本批不为追逐 RPS 修改产品算法、Schema
或中间件参数。
