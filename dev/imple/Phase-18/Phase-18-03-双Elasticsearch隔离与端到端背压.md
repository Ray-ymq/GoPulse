...
Outbox、RabbitMQ、Kafka、Marshaller 和 sink 写入建立一致的有界背压。本批只修复 Phase-18-01/02 证据支持的瓶颈和无界路径。

## 2. 前置条件

- Phase-18-01/02 已合入主线，单/多副本基线、第一瓶颈和所有权证据可复核。
...
- 150 RPS 稳态与 300 RPS 突发 SLO、swap/OOM 和 10 分钟排空门禁通过。
