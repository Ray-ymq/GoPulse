...
- 核对六份实施记录都存在且与实际工作相符。
- 在全部验收通过后，将根 `VERSION` 从 Phase 1 原始当前版本一次性更新为已确定的唯一目标版本。
...
16. 将根 `VERSION` 一次性更新为 Phase 1 唯一目标版本，检查暂存范围并完成阶段提交。
...
- `VERSION` 等于 Phase 1 任务开始时确定的唯一目标版本。
