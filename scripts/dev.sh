...
BACKEND_KEYS=(
  ...
  BACKEND_LOG_READ_ALIAS BACKEND_LOG_QUERY_DEFAULT_RANGE BACKEND_LOG_QUERY_MAX_RANGE
...
MONITOR_KEYS=(
  ...
  MONITOR_PUBLISH_TIMEOUT MONITOR_ROUTER_URL MONITOR_ROUTER_TOKEN LOG_MONITOR_INGEST_TOKEN MONITOR_LOG_MAX_BYTES MONITOR_LOG_FUTURE_SKEW REDIS_HOST REDIS_PORT REDIS_PASSWORD REDIS_DB
...
MARSHALLER_KEYS=(
  ...
  MARSHALLER_ELASTICSEARCH_URL MARSHALLER_ELASTICSEARCH_TIMEOUT MARSHALLER_LOG_TEMPLATE MARSHALLER_LOG_INDEX_PREFIX
...
ALL_CONFIG_KEYS=(
  ...
  MONITOR_URL MONITOR_HTTP_HOST MONITOR_HTTP_PORT MONITOR_API_TOKEN MONITOR_REQUEST_TIMEOUT MONITOR_SHUTDOWN_TIMEOUT
  MONITOR_PLUGIN_STARTUP_TIMEOUT MONITOR_PLUGIN_STOP_TIMEOUT MONITOR_SCRAPE_INTERVAL MONITOR_SCRAPE_TIMEOUT
  MONITOR_PUBLISH_TIMEOUT MONITOR_ROUTER_URL MONITOR_ROUTER_TOKEN LOG_MONITOR_INGEST_TOKEN MONITOR_LOG_MAX_BYTES MONITOR_LOG_FUTURE_SKEW
...
declare -A DEFAULTS=(
  ...
  [MARSHALLER_ELASTICSEARCH_URL]=http://127.0.0.1:9200 [MARSHALLER_ELASTICSEARCH_TIMEOUT]=3s [MARSHALLER_LOG_TEMPLATE]=gopulse-logs-v1-template [MARSHALLER_LOG_INDEX_PREFIX]=gopulse-logs-v1-
  ...
  [LOG_MONITOR_INGEST_TOKEN]=local-log-ingest-token-change-me-32-bytes [MONITOR_LOG_MAX_BYTES]=65536 [MONITOR_LOG_FUTURE_SKEW]=5m
  ...
  [BACKEND_LOG_READ_ALIAS]=gopulse-logs-v1-read [BACKEND_LOG_QUERY_DEFAULT_RANGE]=15m [BACKEND_LOG_QUERY_MAX_RANGE]=24h
