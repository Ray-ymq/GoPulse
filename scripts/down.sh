...
declare -A DOTENV=()
declare -A DEFAULTS=([ELASTICSEARCH_PORT]=9200 [KAFKA_PORT]=9092 [VICTORIAMETRICS_PORT]=8428 [VICTORIAMETRICS_USERNAME]=gopulse-marshaller [VICTORIAMETRICS_PASSWORD]=local-victoriametrics-password)
