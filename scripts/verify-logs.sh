...
self_test(){
  ...
  backend=(env APP_ENV=test MYSQL_DATABASE=x MYSQL_USER=x MYSQL_PASSWORD=x REDIS_PASSWORD=x RABBITMQ_URL=amqp://x:x@127.0.0.1:5672/ AUTH_JWT_SECRET=01234567890123456789012345678901 MONITOR_API_TOKEN=abcdefghijklmnopqrstuvwxyzABCDEF BACKEND_VICTORIAMETRICS_PASSWORD=abcdefghijklmnopqrstuvwxyzABCDEF)
