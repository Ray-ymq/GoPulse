...
write_environment() {
  ...
  MONITOR_API_TOKEN="acceptance-monitor-$TOKEN-0123456789abcdef"
...
BACKEND_VICTORIAMETRICS_URL=http://$PUBLISHED_HOST:$VICTORIAMETRICS_PORT
BACKEND_VICTORIAMETRICS_USERNAME=acceptance-marshaller
BACKEND_VICTORIAMETRICS_PASSWORD=acceptance-victoriametrics-$TOKEN-password
...
backend_environment() {
  env \
    ...
    BACKEND_VICTORIAMETRICS_URL="http://$PUBLISHED_HOST:$VICTORIAMETRICS_PORT" BACKEND_VICTORIAMETRICS_USERNAME=acceptance-marshaller BACKEND_VICTORIAMETRICS_PASSWORD="acceptance-victoriametrics-$TOKEN-password" \
    AUTH_JWT_SECRET="$JWT_SECRET" AUTH_JWT_TTL=2h AUTH_COOKIE_NAME="$COOKIE_NAME" AUTH_COOKIE_SECURE=false \
    MONITOR_API_TOKEN="$MONITOR_API_TOKEN" MONITOR_URL="$MONITOR_URL" MONITOR_REQUEST_TIMEOUT=30s \
